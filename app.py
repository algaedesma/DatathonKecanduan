...
if "model_xgb.pkl" not in os.listdir():
    st.error("❌ Model belum tersedia. Harap unggah 'model_xgb.pkl' ke Space.")
    st.stop()
else:
...
if st.button("Prediksi"):
    ...
    st.success(f"📊 Tingkat kecanduan diprediksi: **{prediction:.2f}**")